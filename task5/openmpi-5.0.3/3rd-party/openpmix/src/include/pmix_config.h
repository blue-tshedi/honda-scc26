...
#define PMIX_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/home/honda/opt/openmpi\' \'--without-tests-examples\' \'--enable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Mon Apr  6 14:21:33 UTC 2026"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "head.sisco"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "honda"
...
#define PMIX_PACKAGE_STRING "PMIx honda@head.sisco Distribution"
