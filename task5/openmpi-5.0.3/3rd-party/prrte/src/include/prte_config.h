...
#define PRTE_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/home/honda/opt/openmpi\' \'--enable-prte-ft\' \'--with-proxy-version-string=5.0.3\' \'--with-proxy-package-name=Open MPI\' \'--with-proxy-bugreport=https://www.open-mpi.org/community/help/\' \'--enable-prte-prefix-by-default\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PRTE_CONFIGURE_DATE "Mon Apr  6 14:26:49 UTC 2026"

/* Hostname where PMIx was built */
#define PRTE_CONFIGURE_HOST "head.sisco"

/* User who built PMIx */
#define PRTE_CONFIGURE_USER "honda"
...
#define PRTE_IDENT_STRING "3.0.5rc2"
...
#define PRTE_PACKAGE_STRING "Open MPI honda@head.sisco Distribution"
...
#define PRTE_PMIX_BASE_CAPABILITY 1
...
#define PRTE_PROXY_VERSION_STRING "5.0.3"
...
#define PRTE_RELEASE_VERSION 5

/* The repository version PMIx Reference Run-Time Environment */
#define PRTE_REPO_REV "2026-04-06"
