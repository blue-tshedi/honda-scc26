...
#define ALIGNOF_OPAL_SHORT_FLOAT_T 2
...
#define HAVE_OPAL_SHORT_FLOAT_COMPLEX_T 1

/* Define to 1 if the system has the type `opal_short_float_t'. */
#define HAVE_OPAL_SHORT_FLOAT_T 1
...
#define MCA_io_romio341_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG  -finline-functions -mcx16 -D__EXTENSIONS__' CPPFLAGS='' FFLAGS='' LDFLAGS='' --enable-shared --disable-static  --prefix=/home/honda/opt/openmpi --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90 ac_cv_lib_cuda_cuMemGetAddressRange=no"
...
#define OMPI_FORTRAN_HAVE_ATTR_DEPRECATED 1
...
#define OMPI_MPIEXT_COMPONENTS "affinity, cuda, ftmpi, rocm, shortfloat"
...
#define OPAL_IDENT_STRING "5.0.3"
...
#define OPAL_PACKAGE_STRING "Open MPI honda@head.sisco Distribution"
...
#define OPAL_RELEASE_DATE "Apr 08, 2024"
...
#define OPAL_TARBALL_VERSION "5.0.3"
...
#define OSHMEM_TARBALL_VERSION "5.0.3"

/* Complete release number of Open SHMEM */
#define OSHMEM_VERSION "5.0.3"
...
#define PACKAGE_STRING "Open MPI 5.0.3"
...
#define SIZEOF_OPAL_SHORT_FLOAT_COMPLEX_T 4

/* The size of `opal_short_float_t', as computed by sizeof. */
#define SIZEOF_OPAL_SHORT_FLOAT_T 2
...
#define opal_short_float_complex_t _Float16 [2]

/* User-selected alternate C type of short float */
#define opal_short_float_t _Float16
